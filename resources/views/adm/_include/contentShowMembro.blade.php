...
<ul class="col-md-9 p-0">
    ...
    <fieldset class="p-3 mb-3">
        ...
        <li>
            <span>Ficha </span>
            <a target="_blank" href="{{ url('/storage/files/') }}/{{ $membro->ncarteirinha }}/{{ $arquivos->ficha }}">Baixar</a>
        </li>
        <li>
            <span>Diploma </span>
            <a target="_blank" href="{{ url('/storage/files/') }}/{{ $membro->ncarteirinha }}/{{ $arquivos->diploma }}">Baixar</a>
        </li>
        <li>
            <span>Diploma verso </span>
            <a target="_blank" href="{{ url('/storage/files/') }}/{{ $membro->ncarteirinha }}/{{ $arquivos->diploma_verso }}">Baixar</a>
        </li>
        <li>
            <span>RG </span>
            <a target="_blank" href="{{ url('/storage/files/') }}/{{ $membro->ncarteirinha }}/{{ $arquivos->rg }}">Baixar</a>
        </li>
        <li>
            <span>CPF </span>
            <a target="_blank" href="{{ url('/storage/files/') }}/{{ $membro->ncarteirinha }}/{{ $arquivos->cpf }}">Baixar</a>
        </li>
        <li>
            <span>Título </span>
            <a target="_blank" href="{{ url('/storage/files/') }}/{{ $membro->ncarteirinha }}/{{ $arquivos->titulo }}">Baixar</a>
        </li>
        <li>
            <span>Comprovante </span>
            <a target="_blank" href="{{ url('/storage/files/') }}/{{ $membro->ncarteirinha }}/{{ $arquivos->comprovante }}">Baixar</a>
        </li>
    </fieldset>
</ul>
